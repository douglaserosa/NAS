...
for chunk in {512,4096}
        do
            ...
            do
                echo "running ep-openmp-static" S 4 $chunk "exec" $i  
                ./ep-openmp-static S 4 $chunk > results/openmp-static-s-4/ep-openmp-static-S-4-$chunk--$i
                ./battery >> results/openmp-static-s-4/ep-openmp-static-S-4-$chunk--$i
            done
        done
