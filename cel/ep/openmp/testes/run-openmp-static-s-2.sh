...
for chunk in {512,4096}
        do
            ...
            do
                echo "running ep-openmp-static" S 2 $chunk "exec" $i  
                ./ep-openmp-static S 2 $chunk > results/openmp-static-s-2/ep-openmp-static-S-2-$chunk--$i
                ./battery >> results/openmp-static-s-2/ep-openmp-static-S-2-$chunk--$i
            done
        done
